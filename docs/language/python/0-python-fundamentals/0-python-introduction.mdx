...
<div style={{
    ...
    <Image img={"/docs-assets/language/python/0-python-fundamentals/img/logo/python-logo-master-v3-TM.png"}/>
</div>
...
|:----------------------------------------------------:|:-----------------------------------------------------:|:------------------------------------------------------:|
| <Image img={"/docs-assets/language/python/0-python-fundamentals/img/logo/flask-logo.png"} /> | <Image img={"/docs-assets/language/python/0-python-fundamentals/img/logo/django-logo.png"} /> | <Image img={"/docs-assets/language/python/0-python-fundamentals/img/logo/fastapi-logo.png"} /> |
...
|:----------------------------------------:|:--------------------------------------:|:----------------------------------------------------:|
| ![Pandas Logo](/docs-assets/language/python/0-python-fundamentals/img/logo/pandas-logo.png) | ![Numpy Logo](/docs-assets/language/python/0-python-fundamentals/img/logo/numpy-logo.png) | ![Scikit-learn Logo](/docs-assets/language/python/0-python-fundamentals/img/logo/scikit-learn-logo.png) |
...
|                    TensorFlow                    |                  PyTorch                   |
|:------------------------------------------------:|:------------------------------------------:|
| ![TensorFlow Logo](/docs-assets/language/python/0-python-fundamentals/img/logo/tensorflow-logo.png) | ![PyTorch Logo](/docs-assets/language/python/0-python-fundamentals/img/logo/pytorch-logo.png) |
